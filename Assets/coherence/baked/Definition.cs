...
namespace Coherence.Generated
{
    ...
    {
        public const string schemaId = "d2356a14c9824d946312336fe8774c6c934ff345";
        ...
        public const uint InternalCar_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170 = 153;
        public const uint InternalCar_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515 = 154;
        ...
        private static readonly Dictionary<uint, string> componentNamesForTypeIds = new Dictionary<uint, string>() 
        {
            ...
            { 153, "Car_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170" },
            { 154, "Car_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515" },
        };
        			...
        			IInBitStream bitStream, Logger logger)
        {
            ...
            switch (componentType)
            {
                ...
                case InternalCar_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170:
                    return Car_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170.Deserialize(inProtocolStream);
                case InternalCar_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515:
                    return Car_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515.Deserialize(inProtocolStream);
                default:
                    return (null, 0);
            }
        }
            ...
            IOutProtocolBitStream protocolStream, Logger logger)
        {
            switch (serializeAs)
            {
                ...
                case InternalCar_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170:
                    return Car_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170.Serialize((Car_319d1a922b47d804fb9960cdc792d6fa_CarController_3897654430183329170)data, mask, protocolStream, logger);
                case InternalCar_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515:
                    return Car_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515.Serialize((Car_319d1a922b47d804fb9960cdc792d6fa_Rigidbody2D_3118235588787588515)data, mask, protocolStream, logger);
                default:
